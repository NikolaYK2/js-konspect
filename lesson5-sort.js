...
//     }
// }
// const compareFn1 = (a, b) => a - b;//Сокращение верхней функции
// console.log(numbers.sort(compareFn))
// //ПО убыванию можно исп. метод reverse()
// console.log(numbers.sort(compareFn1).reverse())
//========================================================
//=========МЕТОД sort===================================================
// const students = [
//     {
...
// // console.log(students.sort((a,b)=>a.name.localeCompare(b.name)))//по имени регистронезависимым способом
...
//     for (let i = 0; i < nums.length - 1 - j; i++) {//по возрастанию / -1 что бы не вывалиться за пределы массива
//         //- j = 0 бежим до конца, когда 1 то -1(типо уже незачем сравнивать с последним отсортированным числом)
...
//             [nums[i + 1], nums[i]]/*- это не массив*/ = [nums[i], nums[i + 1]];
//         }
//     }
//     if (isSorted) break;
// }

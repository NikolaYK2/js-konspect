...
// //вызов с аргументами
// foo.bind({name: 2}, 2, 3)();//в сам bind
// foo.bind({name: 2})(3, 4);//в вызов
// foo.bind({name: 2}, 5)(6);//или так
// const bindFoo1 = foo.bind({name: 2}, 1, 2);//Функцию сразу не вызывает, возвращает обертку,
...
// console.log(a.getMsg2());// this ---> window так как getMsg() стрелочная fn, а у обьекта нет своего LE
// -------------------------------------------------------------
// const a = {
//     name: 'a',
//     getName() {
...
// // вызов получается на 242 строчке - cb(), простой вызов а значит this window.name = ничего
// --------------------------------------------------------------
// const user ={
//     name: 'Vita',
//     showName(){

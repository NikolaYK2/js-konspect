...
// `${user}`;
// user > 5;
//теперь зачем-то в обьекте можно написать логику ---------------------------
// const user = {
//     age: 31,
//     name: 'Nik',
//     [Symbol.toPrimitive]: function (hint) {
...
//     name: 'Vit',
// }
// console.log(user > user1)//false - а как бы первый пользователь старше
// -----------------------------------------------
// const user = {
//     [Symbol.toPrimitive]: function (hint) {
//         return 2
...
//3. if 'string'-если выбрал -> то сначала пытается у обьекта вызвать метод toString(), если и его нет то -Ю valueOf()

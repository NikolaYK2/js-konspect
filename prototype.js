...
// //Автоматически делается alex.__proto__ = User.protorype - {constructor: User} - этот обьект будет прототипом для всех экзэмпляров наших fn constructors
...
// Array.prototype.__proto__ ---> Object.prototype - потому что мы у Array берем обьект prototype, a у него __proto__, а конструктор обьекта это Object

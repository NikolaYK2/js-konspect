...
//     }
//
//     //Geteri setori нужны для контроля к примеру присваивания нового знаечния к св-в  set name(value)
...
// console.log(u1.name);//Обращение к приватному методу через get name() = (name) - пишется как св-в но является функцией
...
//         // нужно передать так же три параметра constructoru бати (name, site, dob) и 4-ый который хотим добавить - tech;
//         super(name, site, dob);
//         this.tech = tech;
//     }
//     code(){
